...
<h2 style="margin-top: 0;text-transform: capitalize;">Editing feature</h2>
<form method="POST" action="/features/edit/<?=$data['id']?>">
	<label style='text-transform: capitalize;'>ref cat id</label><br>
	<input type="text" class="form-control" name="ref_cat_id" value="<?=$data["ref_cat_id"]?>"><br>
	...
	<input type="text" class="form-control" name="visible_to_clients" value="<?=$data["visible_to_clients"]?>"><br>
	<label style='text-transform: capitalize;'>invisible to role</label><br>
	<input type="text" class="form-control" name="invisible_to_role" value="<?=$data["invisible_to_role"]?>"><br>
	<label style='text-transform: capitalize;'>icon link</label><br>
	<input type="text" class="form-control" name="icon_link" value="<?=$data["icon_link"]?>"><br>
