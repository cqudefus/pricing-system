...
<form method="POST" action="/users/add">
	...
	<input type='text' class='form-control' name='user_lastname' placeholder='user lastname'><br>
	<label style='text-transform: capitalize;'>user fullname</label><br>
	<input type='text' class='form-control' name='user_fullname' placeholder='user fullname'><br>
	<label style='text-transform: capitalize;'>user ref role</label><br>
	<input type='text' class='form-control' name='user_ref_role' placeholder='user ref role'><br>
