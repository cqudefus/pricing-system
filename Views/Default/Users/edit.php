...
<h2 style="margin-top: 0;text-transform: capitalize;">Editing user</h2>
<form method="POST" action="/users/edit/<?=$data['user_id']?>">
	...
	<input type="text" class="form-control" name="user_lastname" value="<?=$data["user_lastname"]?>"><br>
	<label style='text-transform: capitalize;'>user fullname</label><br>
	<input type="text" class="form-control" name="user_fullname" value="<?=$data["user_fullname"]?>"><br>
	<label style='text-transform: capitalize;'>user ref role</label><br>
	<input type="text" class="form-control" name="user_ref_role" value="<?=$data["user_ref_role"]?>"><br>
